...
| `4.14/susfs-port.patch` | realme AndroidS MTK 4.14.186 树适配补丁：上游核心的 12–5.9 适配版 + 上游 kstat 面（详见 `localworkspace/pipelines/susfs-k4.14/README.md`；编译面：build-RMX2117.yml 的 susfs 模式，本版 port 待构建） |
...
| `4.19/susfs-port.patch` | LOS 4.19 树适配补丁：上游核心的 12–5.9 适配版 + 上游 kstat 面（详见 `localworkspace/pipelines/susfs-k4.19/README.md`；编译面：build-alioth.yml 的 susfs 模式，本版 port 待构建） |
